 ...
 * @version         3.0.0
 */
abstract class REST_Controller_Smartmobile extends CI_Controller {
     ...
     * @return void
     */
    public function __construct($config = 'restsmartmobile')
    {
        parent::__construct();
    ...
    protected function _check_login($username = NULL, $password = FALSE)
    {
        ...
        ##ini kodingan login dari database##
        $this->load->model('Smart_mobile_mhs_model/Api_Model');
        $usp = $this->Api_Model->get_valid_login();
        $data = array();
        foreach($usp as $key => $val){  
