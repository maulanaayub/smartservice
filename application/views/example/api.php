...
<head>
    <meta charset="utf-8">
    <title>IAIN SALATIGA OAUTH2 || SMART CAMPUS </title>
            ...
            <form class="form-inline">
                ...
                <div class="form-group">
                    <label for="authorize">
                        ...
                        <div>Link Auth <a target="_blank" href="/service_iain/oauth2/authorize?response_type=code&client_id=client&redirect_uri=http://www.aditya-nursyahbani.net&state=xyz&scope=country">/service_iain/oauth2/authorize?response_type=code&client_id=client&redirect_uri=<?= base_url('oauth2/test'); ?>&state=xxx&scope=country</a></div><br>
                    </label><br>
    ...
    <script>
        $(document).ready(function() {
            $("#btn-refresh").click(function(e) {
                ...
                $.post('/service_iain/oauth2/RefreshToken', data, function(d) {
            ...
            $('#btn-authorize').click(function(e) {
                ...
                $.post('/service_iain/oauth2/authorize/token', data, function(d) {
            ...
            $('#btn-resource').click(function(e) {
                ...
                $.post('/service_iain/api/countries', data, function(d) {
            ...
            $('#btn-resource-limit').click(function(e) {
                ...
                $.post('/service_iain/oauth2/resource/limit', data, function(d) {
                    console.log("Get Authorize => ", d);
                    $('#return-resource').html(JSON.stringify(d));
                }, "json");
            });
            ...
            $('#btn-PasswordCredentials').click(function(e) {
                ...
                $.post('/service_iain/oauth2/PasswordCredentials', data, function(d) {
            ...
            $("#btn-ClientCredentials").click(function(e) {
                ...
                $.post('/service_iain/oauth2/ClientCredentials', data, function(d) {
                    //d = d.JSON.parse(d);
