...
<div class="container mt-4">
    ...
    <nav class="nav nav-borders">
        <a class="nav-link ml-0" href="<?php echo base_url('Smart_sispt/profil') ?>">Profil Akun</a>
        <a class="nav-link active" href="<?php echo base_url('Smart_sispt/ganti_password_sispt') ?>">Ganti Password</a>
    </nav>
    <hr class="mt-0 mb-4" />
    <div class="row">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group show_hide_password_old">
                                        <input class="rounded-0 form-control <?php echo form_error('password_lama_sispt') ? 'is-invalid' : null ?>" name="password_lama_sispt" type="password" placeholder="Password Lama" value="<?php echo set_value('password_lama_sispt') ?>" />
                                        <div class="input-group-prepend">
                                            <a href="" class="input-group-text "><span id="rounded-shp"><i class="fa fa-eye-slash" aria-hidden="true"></i></span></a>
                                        </div>
                                    </div>
                                    <?php
                                    echo form_error('password_lama_sispt');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <label class="small mb-1" for="inputLastName">Password Baru</label>
                                    <div class="input-group show_hide_password_new">
                                        <input class="rounded-0 form-control <?php echo form_error('password_baru_sispt') ? 'is-invalid' : null ?>" name="password_baru_sispt" type="password" placeholder="Password Baru" value="<?php echo set_value('password_baru_sispt') ?>" />
                                        <div class="input-group-prepend">
                                            <a href="" class="input-group-text "><span id="rounded-shp"><i class="fa fa-eye-slash" aria-hidden="true"></i></span></a>
                                        </div>
                                    </div>
                                    <?php
                                    echo form_error('password_baru_sispt');
                                    ?>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group show_hide_password_konfirmasi">
                                        <input class="rounded-0 form-control <?php echo form_error('konfirmasi_password_baru_sispt') ? 'is-invalid' : null ?>" name="konfirmasi_password_baru_sispt" type="password" placeholder="Konfirmasi Password Baru" value="<?php echo set_value('konfirmasi_password_baru_sispt') ?>" />
                                        <div class="input-group-prepend ">
                                            <a href="" class="input-group-text "><span id="rounded-shp"><i class="fa fa-eye-slash" aria-hidden="true"></i></span></a>
                                        </div>
                                    </div>
                                    <?php
                                    echo form_error('konfirmasi_password_baru_sispt');
                                    ?>
                                </div>
                                ...
                                <div class="custom-control custom-checkbox mb-3 d-flex justify-content-end">
                                    ...
                                    <label class="custom-control-label" for="customCheck">Saya setuju dengan mengganti password SMART akan mengganti password SIAKAD</label>
                                </div>
...
<script>
    <?php
    if ($this->session->flashdata('pesan') == 'update_pass_sispt_success') {
    ?>
        $("#toast_for_update_pass_success").toast("show");
    <?php
    } else if ($this->session->flashdata('pesan') == 'update_pass_sispt_failed') {
    ?>
