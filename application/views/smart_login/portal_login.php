                        ...
                        <div class="col-xl-4 col-lg-6 col-md-8 col-sm-11">
                            ...
                            <div class="card rounded-0 mt-5 mb-2">
                                <div class="card-body p-3 text-center">
                                    <div class="mb-3 ml-5 mr-5 mt-3">
                                        <img class="img-fluid" src="<?php echo base_url(); ?>media/images/logosmart/smart.svg" />
                                    </div>

                                    <div class="h3 font-weight">Single Sign ON (SSO)</div>
                                    <div class="h4 font-weight-light">IAIN Salatiga</div>
                                ...
                                <div class="card-body px-5 py-3">
                                    <div class="small text-center">
                                        Tidak bisa masuk?
                                        <a href="<?php echo base_url("smart_auth/forgot_password") ?>">Lupa password</a>
                                    </div>
