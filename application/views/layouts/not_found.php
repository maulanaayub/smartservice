                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="text-center mt-4">
                                <img class="img-fluid p-4" src="<?php echo base_url(); ?>assets/sb_admin_pro/dist/assets/img/illustrations/404-error.svg" alt="" />
                                <p class="lead">halaman yang diminta tidak ditemukan diserver</p>
